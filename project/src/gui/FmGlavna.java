...
public class FmGlavna extends javax.swing.JFrame {
    ...
    public FmGlavna() {
        initComponents();
        setLocationRelativeTo(null);//ovo postavlja formu na centar
    }
    ...
    private void jMenuItem1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem1ActionPerformed
        FmUnos unos = new FmUnos();
        unos.setVisible(true);//da bi smo videli formu unesi itd...
